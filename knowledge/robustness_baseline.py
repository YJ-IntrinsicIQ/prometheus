...
ROBUSTNESS_FAILURE_CLASSES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "closure_gaps": [
            "classification is clean, but OCR execution remains unavailable in this baseline",
        ],
    },
    {
        ...
        "closure_gaps": [
            "explicit status and status-synonym fixtures exist, but more corpus statuses are needed",
        ],
    },
    {
        ...
        "closure_gaps": [
            "Tanla committee artifacts pass, but other committee payload shapes are not yet in the corpus manifest",
        ],
    },
    {
        ...
        "closure_gaps": [
            "current Tanla QA passes, but cross-company brief duplication coverage is still thin",
        ],
    },
    {
