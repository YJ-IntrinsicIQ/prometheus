...
FAILURE_CLASS_REGISTRY: List[Dict[str, Any]] = [
    {
        ...
        "description": "A cleaned item still contains period evidence that the shared chronology resolver cannot interpret safely, typically because source-year anchoring, historical example clauses, or conflicting year mentions were not separated cleanly.",
        "status": "implemented",
